...
class ConsultationSurvey(Base):
    ...
    senior_sharing_revoked_at: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
    senior_sharing_revoke_reason: Mapped[str | None] = mapped_column(Text, nullable=True)
