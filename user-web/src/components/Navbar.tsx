              ...
              <>
                {memberType !== "branch_manager" && (
                  <>
                    ...
                    <Link href="/consultation" className={pathname.startsWith("/consultation") && !pathname.startsWith("/consultation/notes") ? "active" : ""}>상담 라운지</Link>
                    <Link href="/consultation/notes" className={pathname.startsWith("/consultation/notes") ? "active" : ""}>상담 관리</Link>
